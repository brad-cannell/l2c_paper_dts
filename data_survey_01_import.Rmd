...
Eventually, it would be nice to use the single, complete analysis dataset that we are creating. For now, there is a ton of data management in this code.
...
# 2021-03-16: v1 imported with 264 rows and 803 columns.
# 2021-03-16: v2 imported with 247 rows and 199 columns.
# 2021-03-16: v3 imported with 180 rows and 526 columns.
# 2021-03-16: v4 imported with 137 rows and 582 columns.
# 2021-03-16: v5 imported with 129 rows and 630 columns.
```
...
# 2021-03-16: REDCap imported with 12 rows and 3 columns.
```
...
master_log <- read_excel(
  ...
  col_types = c("text", rep("skip", 6), "text", rep("skip", 26)),
  skip = 1
) %>% 
...
# 2021-03-16: Master log imported with 271 rows and 2 columns.
```
...
# 2021-03-16: 250 participants have been randomized to a treatment group.
```
